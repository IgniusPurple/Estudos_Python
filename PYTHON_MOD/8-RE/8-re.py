...
# O r significa que esamos trabalahndo com uma string bruta (raw sting)
match = re.search(r'pessoas em programadores',text)
print('Índice inical', match.start())
...
# 5 - Verificando o final de ums string
rule_end = r'!$'
phrases2 = 'O dis está lindo'
